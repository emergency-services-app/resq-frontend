...
const AddEmergencyContactScreen = () => {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			console.log("Error adding emergency contact:", {
				error,
				message: error?.message,
				response: error?.response?.data,
			});
			Alert.alert("Error", error?.response?.data?.message || "Failed to add emergency contact");
		} finally {
			setIsLoading(false);
		}
	};
		...
		<SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
			...
			<ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
				...
				>
					...
					<Text style={[styles.headerSubtext, { color: theme.textSecondary }]}>Add a new emergency contact</Text>
				</LinearGradient>
				...
				<View style={styles.formContainer}>
					...
					<TouchableOpacity
						...
						disabled={isLoading}
					>
						{isLoading ? <ActivityIndicator color="#fff" /> : <Text style={styles.submitButtonText}>Add Contact</Text>}
					</TouchableOpacity>
				</View>
			</ScrollView>
		</SafeAreaView>
