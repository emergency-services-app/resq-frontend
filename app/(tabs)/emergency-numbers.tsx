...
import {
  getCommonContacts,
  getUsersContacts,
} from "../../services/api/emergency-contacts";
...
const EmergencyContactsScreen = () => {
  ...
  // Fetch common contacts on component mount
  useEffect(() => {
    const loadContacts = async () => {
      try {
        const response = await getUsersContacts();
        console.log(response, "Contacts respose");

        setCommonContacts(response.data.data);
          ...
          {emergencyServices.map((service, index) => (
            ...
            >
              ...
              <View style={styles.serviceInfo}>
                ...
                <Text style={[styles.cardNumber, { color: service.color }]}>
                  {service.number}
                </Text>
              </View>
              <TouchableOpacity
            ...
            commonContacts.map((contact) => (
              ...
              >
                <View style={styles.contactInfo}>
                  ...
                  >
                    <Icon name="user-o" size={24} color="#fff" />
                  </View>
                  <View>
