					...
					{isEditing ? (
						<>
							<View style={styles.inputContainer}>
								...
								<Text style={[styles.input, { color: theme.text }]}>{editedUser.name}</Text>
							</View>
							<View style={styles.inputContainer}>
								<Text style={[styles.label, { color: theme.text }]}>Email</Text>
								<Text style={[styles.input, { color: theme.text }]}>{editedUser.email}</Text>
							</View>
							<View style={styles.inputContainer}>
								<Text style={[styles.label, { color: theme.text }]}>Phone</Text>
								<Text style={[styles.input, { color: theme.text }]}>{editedUser.phone}</Text>
							</View>
						</>
					) : (
						<>
